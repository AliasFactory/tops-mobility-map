 ...
 *
 * Pure, dependency-free proximity math shared by the browser map (automap.js)
 * and the Node test-suite. Loads as a global (window.TraderFinder) in the
 * browser and as a CommonJS module (require('./traders.js')) under Node.
 */
