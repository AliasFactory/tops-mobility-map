 ...
 *
 * Pure, dependency-free routing math shared by the browser map (automap.js)
 * and the Node test-suite. Loads as a global (window.RoutePlanner) in the
 * browser and as a CommonJS module (require('./route.js')) under Node.
 */
